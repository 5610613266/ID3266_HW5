...
public class ShapeDraw extends JPanel {
    ...
    public ShapeDraw() {  
        ...
        sizeChoice.addItem("Small Size");
        sizeChoice.addItem("Mediam Size");
        sizeChoice.addItem("Large Size");
    ...
    class DrawingArea extends JPanel
        ...
        Size currentSize;
        Size SmallSize,MediamSize,LargeSize; // current size; when a shape is created, this is its size.
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            if (evt.getSource() == sizeChoice) {
                ...
                case 0: currentSize = SmallSize;     break;
                case 1: currentSize = MediamSize;   break;
                case 2: currentSize = LargeSize;    break;
